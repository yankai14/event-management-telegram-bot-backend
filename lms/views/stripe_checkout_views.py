...
class StripeCheckoutGatewayViewSet(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if status == 5:
            if username and eventInstanceCode and fee and status:
            ...
            return JsonResponse({"detail":status}, status=403)
...
class StripeCheckoutWebhook(APIView):
    ...
    def post(self, request, *args, **kwargs):
        endpoint_secret = os.getenv("STRIPE_WEBHOOK_ENDPOINT_KEY")
